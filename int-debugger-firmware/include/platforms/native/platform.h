...
#include "platforms/stm32/gpio.h"
#include "timing.h"
#include "platforms/stm32/timing_stm32.h"
...
#define BUS_IO_EN_PORT GPIOC
#define BUS_IO_EN_PIN GPIO8
#define BUS_INT_EN_PORT GPIOC
#define BUS_INT_EN_PIN GPIO9

#define SPI SPI2
#define SPI_RCC RCC_SPI2
#define SPI_PORT GPIOB
#define SPI_SS_PIN GPIO12
#define SPI_SCK_PIN GPIO13
#define SPI_MISO_PIN GPIO14
#define SPI_MOSI_PIN GPIO15

#define P_INT_PORT GPIOC
#define P_INT_PIN GPIO6
#define P_INT_2_PIN GPIO7

#define DEBUGGER_PINS_PORT GPIOC
#define DEBUGGER_TX_PIN GPIO5
#define DEBUGGER_RX_PIN GPIO4
...
#define TMS_SET_MODE_OUTPUT() do { \
  gpio_set(TMS_DIR_PORT, TMS_DIR_PIN); \
  gpio_set_mode(TMS_PORT, GPIO_MODE_OUTPUT_50_MHZ, \
                GPIO_CNF_OUTPUT_PUSHPULL, TMS_PIN); \
} while(0)

#define TMS_SET_MODE_INPUT() do { \
