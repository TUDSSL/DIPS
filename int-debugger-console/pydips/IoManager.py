...
class IoManager:
    ...
    def _get_responses_windows(self, timeout_sec):
        ...
        while True:
            ...
            try:
                self.stdout.flush()
                raw_output = self.stdout.readline()
                output = raw_output.replace(b"\r", b"\n")
            except IOError:
                pass
            ...
            try:
                ...
                raw_new, responses_list_new = self._get_responses_list(raw_output, "stderr")
            except IOError:
                pass
    ...
    def _get_responses_unix(self, timeout_sec):
        ...
        while True:
            ...
            for fileno in events:
                ...
                [raw, responses_list] = self._get_responses_list(raw_output, stream)
                responses += responses_list
                raw_responses += raw
    ...
    def _get_responses_list(
        ...
        return [response_list, responses]
